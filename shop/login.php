  ...
  <div class="modal-dialog ">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <p class="text-center">ไม่ได้เป็นสมาชิกใช่มั้ย? <a data-toggle="modal"  data-dismiss="modal" href="#ModalSignup"> สมัครสมาชิก. </a> <br>
          <a href="index.php?content=forgot_password" > ลืมรหัสผ่าน? </a> </p>
      </div>
    </div>
    <!-- /.modal-content --> 
