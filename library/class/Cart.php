...
class cart{
		...
		public function newCart()
		{
				if(isset($_COOKIE['id_customer'])){
					...
					list($id_cart)= dbFetchArray(dbQuery("SELECT MAX(id_cart) FROM tbl_cart"));
					while($id_cart <= $this->maxId()){
						$id_cart++;
					}
					$sql = dbQuery("INSERT INTO tbl_cart(id_cart, id_customer, date_add) VALUES ($id_cart, $id_customer, NOW())");
		...
		{
			$sql = dbQuery("SELECT * FROM tbl_cart_product WHERE id_cart = ".$this->id_cart." ORDER BY date_add ASC");
			return $sql;	
		}
      ...
      <div class='nav navbar-nav navbar-right hidden-xs'>
        <div class='dropdown  cartMenu '> 
          ...
          <div class='w100 miniCartTable scroll-pane'>
		   ...
		   <td>
		   <h3></h3>
		   <h3 align='center'> ยังไม่มีรายการสินค้า (No item in cart) </h3>
		  <h3></h3>
		   </td>
		   </tr>
			 </table>
			...
			<div class='miniCartFooter  text-right'>
						  <h3 class='text-right subtotal' id='sumtotalcartin'>  ราคารวม (Sub total) : (ว่างเปล่า) </h3>
						  <a class='btn btn-sm btn-primary' href='index.php?content=cart'>ดำเนินการสั่งซื้อ (Check out) </a>
						 </div>
						<!--/.miniCartFooter--> 
         ...
         echo"  </div>
          <!--/.dropdown-menu-->
		  <a href='#' class='dropdown-toggle' data-toggle='dropdown'> <i class='fa fa-shopping-cart'> </i> <span class='cartRespons' id='sumtotalcart'>ตะกร้า : Cart (ว่างเปล่า : Empty)</span> <b class='caret'> </b> </a>
        </div>
        <!--/.cartMenu-->";
			}else{
			echo"
        ...
        <div class='dropdown  cartMenu '> 
           <div class='dropdown-menu col-lg-4 col-xs-12 col-md-4 '>
            ...
            <div class='miniCartFooter text-right'> 
              ...
              <h3 class='text-right subtotal' id='sumtotalcartin'>  ราคารวม(Sub total) : $sumtotal_cart1 </h3> 
            <a class='btn btn-sm btn-primary' href='index.php?content=cart'>ดำเนินการสั่งซื้อ (Check out)</a> </div>
            <!--/.miniCartFooter--> ";
            
         echo"  </div>
          <!--/.dropdown-menu-->
		  <a href='#' class='dropdown-toggle' data-toggle='dropdown'> <i class='fa fa-shopping-cart'> </i> <span class='cartRespons' id='sumtotalcart'>";if($sumtotal_cart == ""){ echo "ตะกร้า:Cart (ว่างเปล่า:Empty)";}else{
      ...
      <div class='nav navbar-nav navbar-right hidden-xs'>
        <div class='dropdown  cartMenu '> 
		  ...
		  <h3></h3>
			...
			<div class='miniCartFooter  text-right'>
						  <h3 class='text-right subtotal' id='sumtotalcartin'>  ราคารวม (Sub total) : (ว่างเปล่า) </h3>
						  <a class='btn btn-sm btn-primary' href='index.php?content=cart'>ดำเนินการ(Check out) </a>
						 </div>
						<!--/.miniCartFooter--> 
         ...
         echo"  </div>
          <!--/.dropdown-menu-->
		  <a href='#' class='dropdown-toggle' data-toggle='dropdown'> <i class='fa fa-shopping-cart'> </i> <span class='cartRespons' id='sumtotalcart'>ตะกร้า (ว่างเปล่า : Empty)</span> <b class='caret'> </b> </a>
        </div>
        <!--/.cartMenu-->";
      ...
      <div class='nav navbar-nav navbar-right hidden-xs'>
				...
				<div class='w100 miniCartTable scroll-pane'>
				 <table id='mini_cart'>";
				   ...
				   echo "
					...
					<div class='miniCartFooter text-right'> 
					  <h3 class='text-right subtotal' id='sumtotalcartin'>  ราคารวม(Sub total) : $sumtotal_cart </h3> 
					  <a class='btn btn-sm btn-primary' href='index.php?content=cart'>ดำเนินการ (Check out)</a> 
					 </div>
         	</div>
		  <a href='#' class='dropdown-toggle' data-toggle='dropdown'> <i class='fa fa-shopping-cart'> </i> <span class='cartRespons' id='sumtotalcart'>";if($sumtotal_cart == ""){ echo "ตะกร้า(ว่างเปล่า:Empty)";}else{
		...
		public function request_cartmini_for_mobile($id_request_order,$id_customer=0){
					...
					<div class='navbar-cart  collapse'>
					  <div class='cartMenu  col-lg-4 col-xs-12 col-md-4 '>
						...
						<div class='miniCartFooter  miniCartFooterInMobile text-right'>
						  <h3 class='text-right subtotal' id='sumtotalcartin_for_mobile'>  ราคารวม(Sub total) :  </h3>
						  <a class='btn btn-sm btn-primary' href='index.php?content=cart'>ดำเนินการ(Check out) </a>
						 </div>
					  </div>
					</div>";
			...
			echo "<!-- this part is duplicate from cartMenu  keep it for mobile -->
               ...
               echo "
						...
						<div class='miniCartFooter  miniCartFooterInMobile text-right'>
						  <h3 class='text-right subtotal'  id='sumtotalcartin_for_mobile'>  ราคารวม(Sub total) : $sumtotal_cart  รายการ</h3>
						  <a class='btn btn-sm btn-info' href='index.php?content=cart'>ดำเนินการ(Check out) </a></div>
						<!--/.miniCartFooter--> 
		...
		public function request_total_for_mobile($id_request_order){
				...
				<span class='cartRespons colorWhite' id='sumtotalcart_for_mobile'>";if($row<1){ $qty = "ว่างเปล่า:Empty";}else{ list($qty) = dbFetchArray($sql); }
		...
		public function request_sumary($id_request_order){
			$product = new Product();
						...
						if($row == "0"){
							$sumtotal_cart = "";
							 echo "<div><div class='alert alert-warning'>ไม่มีสินค้าในตะกร้าของคุณ(No item in cart)</div></div>";
						}else{
			echo " <div class='row'>
    <div class='col-lg-12'>
            ...
            <table class='cartTable table-responsive' style='width:100%'>
              <tbody>
                <tr class='CartProduct cartTableHeader'>
                  ...
                  <td style='width:40%'  >รายระเอียด(Description)</td>
                  <td style='width:10%'  class='delete'>&nbsp;</td>
                  <td style='width:10%' >จำนวน(Qty)</td>
                </tr>
                ";
						$i=0;
						$n=1;
    ...
    <!--/rightSidebar--></div> ";
		...
		public function cartmini_for_mobile($id_cart,$id_customer=0){
			...
			echo "<!-- this part is duplicate from cartMenu  keep it for mobile -->
               ...
               echo "</tbody>
						...
						<div class='miniCartFooter  miniCartFooterInMobile text-right'>
						  <h3 class='text-right subtotal'  id='sumtotalcartin_for_mobile'>  ราคารวม(Sub total) : $sumtotal_cart1  </h3>
						  <a class='btn btn-sm btn-primary' href='index.php?content=cart'>ดำเนินการสั่งซื้อ(Check out) </a></div>
						<!--/.miniCartFooter--> 
		...
		public function total_for_mobile($id_cart,$id_customer=0){
			...
			echo "<button type='button' class='navbar-toggle' data-toggle='collapse' data-target='.navbar-cart'><i class='fa fa-shopping-cart colorWhite'> </i> <span class='cartRespons colorWhite' id='sumtotalcart_for_mobile'>";if($id_cart == "0"){ echo "ตะกร้า:Cart (ว่างเปล่า:Empty)";}else{
		...
		public function cartfull($id_cart,$id_customer=0){
			...
			$product = new Product();
						...
						if($row == "0"){
							...
							$sumtotal_cart1 = "";
							$not = "";
							 echo "<div id='cartfull'><div class='alert alert-warning'>ไม่มีสินค้าในตะกร้าของคุณ(No item in cart)</div></div>";
						}else{
			echo " <div class='row'>
        ...
        <div class='col-xs-12 col-sm-12'>
          ...
          <div style='margin-top:15px;'>
            <div class='box-footer'>
              <div class='pull-left'> <a href='index.php' class='btn btn-primary'> <i class='fa fa-arrow-left'></i> &nbsp; ซื้อสินค้าต่อ(Continue shopping) </a></div>
            </div>
          </div> <!--/ cartFooter --> 
              ...
              <table id='cart-summary' class='std table'>
                <tbody>
                 ...
                 /*  <tr >
                  ...
                  echo "<tr >
                    <td >ราคารวมทั้งหมด(Grand Total)</td>
