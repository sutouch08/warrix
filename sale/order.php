...
if(isset($_GET['message'])){
	...
	<form action ='index.php?content=order&new=y' method='post'>
		...
		<div class='row'><div class='col-lg-12 col-md-12 col-sm-12 col-xs-12' id='product_grid'>
	";
	if(isset($id_cate)){ product_grid($id_cate, $id_customer); }else{ newProduct(getConfig("NEW_PRODUCT_QTY"),$id_customer ); }
	echo"</div></div>";
?>
