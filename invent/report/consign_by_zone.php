...
<?php 
	$page_name = "รายงานสินค้าฝากขายแยกตามโซน";
...
<div class="row">
	<div class="col-sm-8"><h3 style="margin-bottom:0px; margin-top:0px;"><i class="fa fa-list"></i>&nbsp;<?php echo $page_name; ?></h3></div>
...
$(document).ready(function(e) {
	...
	$("#report_form").attr("action","controller/reportController.php?export_consign_by_zone&"+view_report+"&zone="+zone+"&"+zone_report );
...
function get_report(){
	...
	$.ajax({
		url:"controller/reportController.php?consign_by_zone&"+view_report+"&zone="+zone+"&"+zone_report , type:"POST",cache:false,
