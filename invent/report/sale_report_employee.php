...
echo"
<div class='row'>
    <input type='hidden' id='export' value='controller/reportController.php?sale_report_employee&from_date=$from_date&to_date=$to_date'/>
   <div class='col-lg-2'>
...
function get_report(){
	...
	$.ajax({
		url:"controller/reportController.php?SaleReportEmployee&from_date="+from_date+"&to_date="+to_date, type:"GET", cache:false,
