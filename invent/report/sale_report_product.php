<?php 
	$page_menu = "invent_sale_report_product";
...
echo"
<div class='row'>
    <input type='hidden' id='export' value='controller/reportController.php?sale_report_product&from_date=$from_date&to_date=$to_date'/>
   <div class='col-lg-2'>
...
function get_report(){
	...
	$.ajax({
		url:"controller/reportController.php?SaleReportProduct&from_date="+from_date+"&to_date="+to_date, type:"GET", cache:false,
