...
$(document).ready(function(e) {
	...
	$("#report_form").attr("action","controller/reportController.php?export_fifo_report&view="+view+"&"+view_report+"&product="+product+"&"+product_rank+"&warehouse="+warehouse+"&"+warehouse_report );
...
function get_report(){
	...
	$.ajax({
		url:"controller/reportController.php?fifo_report&view="+view+"&"+view_report+"&product="+product+"&"+product_rank+"&warehouse="+warehouse+"&"+warehouse_report , type:"GET",cache:false,
