...
if(isset($_GET['id_product'])&&isset($_GET['step'])&&$_GET['step']==1){
	...
	<div class='row' >
			...
			<h4>&nbsp;</h4>
			<div class='row'><div class='col-lg-12'><p class='pull-right' style='width:150px;'><button class='btn btn-info btn-block' type='submit'>ถัดไป<i class='fa fa-arrow-circle-right'></i></button></p></div></div>
			</form>";	
}
/// step 2 ///
