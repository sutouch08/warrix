...
//********************************************************** TAB1 ******************************************//
	...
	<tr>
		...
		<tr>
			...
			<td width='30%' align='left' style='padding-bottom:10px;'><select name='default_category' class='form-control input-sm'>"; categoryList(); echo"</select></td><td>&nbsp;</td>
		</tr>
		<tr>
	...
	<tr>
		...
		<tr>
			<td width='10%' align='right' style='padding-bottom:10px;'>หมวดหมู่หลัก :&nbsp;</td>
			<td width='30%' align='left' style='padding-bottom:10px;'><select name='default_category' class='form-control input-sm'>"; categoryList($product->default_category_id); echo"</select></td><td>&nbsp;</td>
		</tr>
		<tr>
			<td width='10%' align='right' style='padding-bottom:10px;'>ราคาทุน :&nbsp;</td>
