...
<!-- page place holder -->
<div class="row">
	<div class="col-sm-6"><h3><span class="glyphicon glyphicon-resize-small"></span>&nbsp;<?php echo $page_name; ?></h3>
	</div>
    <div class="col-sm-6">
	   ...
	   if(isset($_GET['view_detail'])&&isset($_GET['id_order_consign'])){
		   ...
		   list($status_consign) = dbFetchArray(dbQuery("SELECT consign_status FROM tbl_order_consign WHERE id_order_consign = '$id_order_consign'"));
		    echo"
		   <li><a href='index.php?content=consign' style='text-align:center; background-color:transparent;'><button type='button' class='btn btn-link'><span class='glyphicon glyphicon-arrow-left' style='color:#5cb85c; font-size:30px;'></span><br />กลับ</button></a></li>";
		   if($status_consign == 0){
       		echo "<li $can_edit ><a href='index.php?content=consign&add=y&id_order_consign=$id_order_consign' style='text-align:center; background-color:transparent;'  ><button type='button' class='btn btn-link'><span class='glyphicon glyphicon-pencil' style='color:#5cb85c; font-size:30px;'></span><br />แก้ไข</button></a></li>";
		   }
			}else if(isset($_GET['edit']) || isset($_GET['add'])){
				if(isset($_GET['id_order_consign'])){$id_order_consign = $_GET['id_order_consign'];
				list($id_customer) = dbFetchArray(dbQuery("SELECT id_customer FROM tbl_order_consign WHERE id_order_consign = '$id_order_consign'"));
		   echo"
		   <li><a href='index.php?content=consign&id_order_consign=$id_order_consign&id_customer=$id_customer&view_detail=y' style='text-align:center; background-color:transparent;'><button type='button' class='btn btn-link'><span class='glyphicon glyphicon-arrow-left' style='color:#5cb85c; font-size:30px;'></span><br />กลับ</button></a></li>";
		   }else{
			    echo"
		   <li><a href='index.php?content=consign' style='text-align:center; background-color:transparent;'><button type='button' class='btn btn-link'><span class='glyphicon glyphicon-arrow-left' style='color:#5cb85c; font-size:30px;'></span><br />กลับ</button></a></li>";
		   }
				  ...
				  echo"
			<li><a href='index.php?content=consign' style='text-align:center; background-color:transparent;'><button type='button' class='btn btn-link'><span class='glyphicon glyphicon-arrow-left' style='color:#5cb85c; font-size:30px;'></span><br />กลับ</button></a></li>
		    <li $can_add><a href='index.php?content=consign&add_consign_check=y' style='text-align:center; background-color:transparent; padding-bottom:0px;' ><button type='button' class='btn btn-link' ><span class='glyphicon glyphicon-plus-sign' style='color:#5cb85c; font-size:30px;'></span><br />เพิ่มรายการกระทบยอด</button></a></li>";
			}else if(isset($_GET['add_consign_check'])){
				  echo"
		   <li><a href='index.php?content=consign&consign_check' style='text-align:center; background-color:transparent;'><button type='button' class='btn btn-link'><span class='glyphicon glyphicon-arrow-left' style='color:#5cb85c; font-size:30px;'></span><br />กลับ</button></a></li>";
		...
		if($consign_valid == 0){
		  echo "
		  <li $can_add><a href='controller/consignController.php?add_consign_diff=y&id_consign_check=$id_consign_check' style='text-align:center; background-color:transparent; padding-bottom:0px;' ><button type='button' class='btn btn-link' ><span class='glyphicon glyphicon-plus-sign' style='color:#5cb85c; font-size:30px;'></span><br />ตัดยอดฝากขาย</button></a></li>";
		   }
		  echo"<li><a href='index.php?content=consign&consign_balance_check&id_consign_check=$id_consign_check' style='text-align:center; background-color:transparent;'><button type='button' class='btn btn-link'><span class='glyphicon glyphicon-th-list' style='color:#5cb85c; font-size:30px;'></span><br />ยอดคงเหลือ</button></a></li>
		  <li><a href='index.php?content=consign&consign_balance&id_consign_check=$id_consign_check' style='text-align:center; background-color:transparent;'><button type='button' class='btn btn-link'><span class='glyphicon glyphicon-th-list' style='color:#5cb85c; font-size:30px;'></span><br />ยอดต่าง</button></a></li>
		   <li><a href='index.php?content=consign&import_fales&id_consign_check=$id_consign_check' style='text-align:center; background-color:transparent;'><button type='button' class='btn btn-link'><span class='glyphicon glyphicon-remove' style='color:#5cb85c; font-size:30px;'></span><br />fales</button></a></li>";
		   }
			}else if(isset($_GET['import_fales']) || isset($_GET['consign_balance']) || isset($_GET['consign_balance_check'])){
		   echo "<li><a href='index.php?content=consign&add_consign_check&id_consign_check=$id_consign_check' style='text-align:center; background-color:transparent;'><button type='button' class='btn btn-link'><span class='glyphicon glyphicon-arrow-left' style='color:#5cb85c; font-size:30px;'></span><br />กลับ</button></a></li>";
		   if(isset($_GET['consign_balance'])){
				  echo"
				 <li> <a href='controller/consignController.php?print_diff&id_consign_check=$id_consign_check' >
			<button type='button' class='btn btn-link'><span class='glyphicon glyphicon-print' style='color:#5cb85c; font-size:30px;'></span><br />พิมพ์</button>
			</a></li>";
				}
				if(isset($_GET['consign_balance_check'])){
				echo"
				 <li> <a href='controller/consignController.php?print_balance&id_consign_check=$id_consign_check' >
			<button type='button' class='btn btn-link'><span class='glyphicon glyphicon-print'style='color:#5cb85c; font-size:30px;'></span><br />พิมพ์</button>
			</a></li>";	
				}
			}else{
		   echo"
		    <li $can_add><a href='index.php?content=consign&consign_check=y' style='text-align:center; background-color:transparent; padding-bottom:0px;' ><button type='button' class='btn btn-link' ><span class='glyphicon glyphicon-record' style='color:#5cb85c; font-size:30px;'></span><br />กระทบยอด</button></a></li>
		   <li $can_add><a href='index.php?content=consign&add=y' style='text-align:center; background-color:transparent; padding-bottom:0px;' ><button type='button' class='btn btn-link' ><span class='glyphicon glyphicon-plus-sign' style='color:#5cb85c; font-size:30px;'></span><br />$page_name</button></a></li>";
	   }
	   ?>
       </ul>
    </div>
...
echo"<form id='add_order_form' action='controller/consignController.php?add=y' method='post'>
	...
	//////////////////// ได้ออเดอร์ ID แล้ว
	if(isset($_GET['id_order_consign'])){ 
		echo"<form id='add_detail_form' action='controller/consignController.php?insert_detail' method='post'>
...
//*********************************************** แก้ไขออเดอร์ **************************************************************//
	...
	echo "
		...
		<p class='pull-right'  >";
		if($consign_status == 0){
			echo "<a href='controller/consignController.php?confirm_consign&id_order_consign=$id_order_consign&id_employee=$id_employee' >
			<button type='button' class='btn btn-primary'>เปิดใบกำกับภาษี</button>
			</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
echo"<form  method='post' id='form'>
		...
		if(isset($_POST['get_rows'])){$get_rows = $_POST['get_rows'];$paginator->setcookie_rows($get_rows);}else if(isset($_COOKIE['get_rows'])){$get_rows = $_COOKIE['get_rows'];}else{$get_rows = 50;}
		$paginator->Per_Page("tbl_order_consign","WHERE (date_add BETWEEN '$from' AND '$to') ORDER BY id_order_consign DESC",$get_rows);
		$paginator->display($get_rows,"index.php?content=consign");
		$Page_Start = $paginator->Page_Start;
		$Per_Page = $paginator->Per_Page;
		echo "
...
<div class='col-sm-12'>
	<table class='table'>
		...
		$result = dbQuery("SELECT id_order_consign,reference,id_customer,date_add,consign_status FROM tbl_order_consign WHERE (date_add BETWEEN '$from' AND '$to') ORDER BY id_order_consign DESC LIMIT $Page_Start , $Per_Page");
		$i=0;
		$row = dbNumRows($result);
		if($row>0){
		while($i<$row){
		...
		echo"<tr >
				...
				<td style='cursor:pointer;' onclick=\"document.location='index.php?content=consign&id_order_consign=$id_order_consign&id_customer=$id_customer&view_detail=y'\">";if($consign_status == 0){ echo "<span style='color:red'>ยังไม่ได้เปิดบิล</span>";}else if($consign_status == 2 ){echo "ยกเลิก";}else{echo "เปิดบิลแล้ว";} echo "</td>
