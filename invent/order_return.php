...
<div class="row">
    ...
    <div class="col-xs-6">
	   ...
	   if(isset($_GET['edit'])&&isset($_GET['id_return_order'])){
		    echo"
		   <li><a href='index.php?content=order_return' style='text-align:center; background-color:transparent; '><button type='button' class='btn btn-link'><span class='glyphicon glyphicon-arrow-left' style='color:#5cb85c; font-size:30px;'></span><br />กลับ</button></a></li>
		   ...
		   echo"
		   <li><a href='index.php?content=order_return' style='text-align:center; background-color:transparent;'><span class='glyphicon glyphicon-arrow-left' style='color:#5cb85c; font-size:30px;'></span><br />กลับ</a></li>";
	   }else{
		   echo"
		   <li $can_add><a href='index.php?content=order_return&add=y' style='text-align:center; background-color:transparent; padding-top:0px; padding-bottom:0px;' ><button type='button' class='btn btn-link' ><span class='glyphicon glyphicon-plus-sign' style='color:#5cb85c; font-size:30px;'></span><br />$page_name</button></a></li>";
	   }
	   ?>
       </ul>
    </div>
