          ...
          <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;ออเดอร์</a>
            ...
            <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-stats"></span>&nbsp;รายงาน2</a>
              <ul class="dropdown-menu">
                 ...
                 <li><a href="index.php?content=consignment_by_zone"><span class="glyphicon glyphicon-list"></span>&nbsp;รายงานบิลส่งของไปฝากขาย แยกตามโซน เรียงตามเลขที่เอกสาร </a></li>
                 <li><a href="index.php?content=consign_by_zone"><span class="glyphicon glyphicon-list"></span>&nbsp;รายงานเอกสารตัดยอดสินค้าฝากขาย แยกตามโซน เรียงตามเลขที่เอกสาร </a></li>
              </ul>
            </li>
